# IBeam.Tests.Identity.Repositories.EntityFramework Agent Prompt

You are working inside `IBeam.Tests.Identity.Repositories.EntityFramework`.
...
Test coverage for IBeam.Identity.Repositories.EntityFramework.
...
- Test the behavior of IBeam.Identity.Repositories.EntityFramework without moving product code into the test project.
...
This test project may reference `IBeam.Identity.Repositories.EntityFramework` and its required collaborators. Do not make production packages depend on test projects.
