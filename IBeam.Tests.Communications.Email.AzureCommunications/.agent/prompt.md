# IBeam.Tests.Communications.Email.AzureCommunications Agent Prompt

You are working inside `IBeam.Tests.Communications.Email.AzureCommunications`.
...
Test coverage for IBeam.Communications.Email.AzureCommunications.
...
- Test the behavior of IBeam.Communications.Email.AzureCommunications without moving product code into the test project.
...
This test project may reference `IBeam.Communications.Email.AzureCommunications` and its required collaborators. Do not make production packages depend on test projects.
