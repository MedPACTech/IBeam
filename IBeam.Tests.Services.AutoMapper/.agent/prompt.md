# IBeam.Tests.Services.AutoMapper Agent Prompt

You are working inside `IBeam.Tests.Services.AutoMapper`.
...
Test coverage for IBeam.Services.AutoMapper.
...
- Test the behavior of IBeam.Services.AutoMapper without moving product code into the test project.
...
This test project may reference `IBeam.Services.AutoMapper` and its required collaborators. Do not make production packages depend on test projects.
