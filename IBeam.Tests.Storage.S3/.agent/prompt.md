# IBeam.Tests.Storage.S3 Agent Prompt

You are working inside `IBeam.Tests.Storage.S3`.
...
Test coverage for IBeam.Storage.S3.
...
- Test the behavior of IBeam.Storage.S3 without moving product code into the test project.
...
This test project may reference `IBeam.Storage.S3` and its required collaborators. Do not make production packages depend on test projects.
