# IBeam.Tests.Identity.Api Agent Prompt

You are working inside `IBeam.Tests.Identity.Api`.
...
Test coverage for IBeam.Identity.Api.
...
- Test the behavior of IBeam.Identity.Api without moving product code into the test project.
...
This test project may reference `IBeam.Identity.Api` and its required collaborators. Do not make production packages depend on test projects.
