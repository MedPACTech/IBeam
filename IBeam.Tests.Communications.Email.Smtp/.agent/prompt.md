# IBeam.Tests.Communications.Email.Smtp Agent Prompt

You are working inside `IBeam.Tests.Communications.Email.Smtp`.
...
Test coverage for IBeam.Communications.Email.Smtp.
...
- Test the behavior of IBeam.Communications.Email.Smtp without moving product code into the test project.
...
This test project may reference `IBeam.Communications.Email.Smtp` and its required collaborators. Do not make production packages depend on test projects.
