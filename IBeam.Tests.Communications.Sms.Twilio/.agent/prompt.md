# IBeam.Tests.Communications.Sms.Twilio Agent Prompt

You are working inside `IBeam.Tests.Communications.Sms.Twilio`.
...
Test coverage for IBeam.Communications.Sms.Twilio.
...
- Test the behavior of IBeam.Communications.Sms.Twilio without moving product code into the test project.
...
This test project may reference `IBeam.Communications.Sms.Twilio` and its required collaborators. Do not make production packages depend on test projects.
