# IBeam.Tests.Storage.FileSystem Agent Prompt

You are working inside `IBeam.Tests.Storage.FileSystem`.
...
Test coverage for IBeam.Storage.FileSystem.
...
- Test the behavior of IBeam.Storage.FileSystem without moving product code into the test project.
...
This test project may reference `IBeam.Storage.FileSystem` and its required collaborators. Do not make production packages depend on test projects.
