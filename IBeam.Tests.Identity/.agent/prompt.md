# IBeam.Tests.Identity Agent Prompt

You are working inside `IBeam.Tests.Identity`.
...
Test coverage for IBeam.Identity.
...
- Test the behavior of IBeam.Identity without moving product code into the test project.
...
This test project may reference `IBeam.Identity` and its required collaborators. Do not make production packages depend on test projects.
