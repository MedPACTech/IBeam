# IBeam.Tests.Storage.AzureBlobs Agent Prompt

You are working inside `IBeam.Tests.Storage.AzureBlobs`.
...
Test coverage for IBeam.Storage.AzureBlobs.
...
- Test the behavior of IBeam.Storage.AzureBlobs without moving product code into the test project.
...
This test project may reference `IBeam.Storage.AzureBlobs` and its required collaborators. Do not make production packages depend on test projects.
