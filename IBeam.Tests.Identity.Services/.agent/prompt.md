# IBeam.Tests.Identity.Services Agent Prompt

You are working inside `IBeam.Tests.Identity.Services`.
...
Test coverage for IBeam.Identity.Services.
...
- Test the behavior of IBeam.Identity.Services without moving product code into the test project.
...
This test project may reference `IBeam.Identity.Services` and its required collaborators. Do not make production packages depend on test projects.
