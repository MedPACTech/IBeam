# IBeam.Tests.Services.Logging Agent Prompt

You are working inside `IBeam.Tests.Services.Logging`.
...
Test coverage for IBeam.Services.Logging.
...
- Test the behavior of IBeam.Services.Logging without moving product code into the test project.
...
This test project may reference `IBeam.Services.Logging` and its required collaborators. Do not make production packages depend on test projects.
