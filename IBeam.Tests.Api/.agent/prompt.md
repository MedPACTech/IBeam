# IBeam.Tests.Api Agent Prompt

You are working inside `IBeam.Tests.Api`.
...
- Test the behavior of IBeam.Api without moving product code into the test project.
...
This test project may reference `IBeam.Api` and its required collaborators. Do not make production packages depend on test projects.
