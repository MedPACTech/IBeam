# IBeam.Tests.Ai Agent Prompt

You are working inside `IBeam.Tests.Ai`.
...
- Test the behavior of IBeam.Ai without moving product code into the test project.
...
This test project may reference `IBeam.Ai` and its required collaborators. Do not make production packages depend on test projects.
