# IBeam.Tests.Repositories Agent Prompt

You are working inside `IBeam.Tests.Repositories`.
...
Test coverage for IBeam.Repositories.
...
- Test the behavior of IBeam.Repositories without moving product code into the test project.
...
This test project may reference `IBeam.Repositories` and its required collaborators. Do not make production packages depend on test projects.
