...
internal static class AzureCommunicationsSmsConnectionStringValidator
{
    public const string FailureMessage =
        "Configuration validation failed for provider AzureCommunications SMS. " +
        AzureCommunicationsSmsOptions.ConnectionStringConfigurationKey +
