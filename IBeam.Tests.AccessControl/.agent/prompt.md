# IBeam.Tests.AccessControl Agent Prompt

You are working inside `IBeam.Tests.AccessControl`.
...
Test coverage for IBeam.AccessControl.
...
- Test the behavior of IBeam.AccessControl without moving product code into the test project.
...
This test project may reference `IBeam.AccessControl` and its required collaborators. Do not make production packages depend on test projects.
