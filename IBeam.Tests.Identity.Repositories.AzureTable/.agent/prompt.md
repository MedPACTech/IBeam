# IBeam.Tests.Identity.Repositories.AzureTable Agent Prompt

You are working inside `IBeam.Tests.Identity.Repositories.AzureTable`.
...
Test coverage for IBeam.Identity.Repositories.AzureTable.
...
- Test the behavior of IBeam.Identity.Repositories.AzureTable without moving product code into the test project.
...
This test project may reference `IBeam.Identity.Repositories.AzureTable` and its required collaborators. Do not make production packages depend on test projects.
