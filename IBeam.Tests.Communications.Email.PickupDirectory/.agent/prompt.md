# IBeam.Tests.Communications.Email.PickupDirectory Agent Prompt

You are working inside `IBeam.Tests.Communications.Email.PickupDirectory`.
...
Test coverage for IBeam.Communications.Email.PickupDirectory.
...
- Test the behavior of IBeam.Communications.Email.PickupDirectory without moving product code into the test project.
...
This test project may reference `IBeam.Communications.Email.PickupDirectory` and its required collaborators. Do not make production packages depend on test projects.
