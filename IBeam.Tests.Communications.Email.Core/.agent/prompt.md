# IBeam.Tests.Communications.Email.Core Agent Prompt

You are working inside `IBeam.Tests.Communications.Email.Core`.
...
Test coverage for IBeam.Communications.Email.Core.
...
- Test the behavior of IBeam.Communications.Email.Core without moving product code into the test project.
...
This test project may reference `IBeam.Communications.Email.Core` and its required collaborators. Do not make production packages depend on test projects.
