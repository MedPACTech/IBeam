# IBeam.Tests.Licensing Agent Prompt

You are working inside `IBeam.Tests.Licensing`.
...
Test coverage for IBeam.Licensing.
...
- Test the behavior of IBeam.Licensing without moving product code into the test project.
...
This test project may reference `IBeam.Licensing` and its required collaborators. Do not make production packages depend on test projects.
