# IBeam.Tests.Services Agent Prompt

You are working inside `IBeam.Tests.Services`.
...
Test coverage for IBeam.Services.
...
- Test the behavior of IBeam.Services without moving product code into the test project.
...
This test project may reference `IBeam.Services` and its required collaborators. Do not make production packages depend on test projects.
