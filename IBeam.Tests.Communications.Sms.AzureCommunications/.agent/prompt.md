# IBeam.Tests.Communications.Sms.AzureCommunications Agent Prompt

You are working inside `IBeam.Tests.Communications.Sms.AzureCommunications`.
...
Test coverage for IBeam.Communications.Sms.AzureCommunications.
...
- Test the behavior of IBeam.Communications.Sms.AzureCommunications without moving product code into the test project.
...
This test project may reference `IBeam.Communications.Sms.AzureCommunications` and its required collaborators. Do not make production packages depend on test projects.
