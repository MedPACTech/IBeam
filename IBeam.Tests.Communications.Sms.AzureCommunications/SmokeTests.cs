...
{
    private const string ConnectionStringKey = AzureCommunicationsSmsOptions.ConnectionStringConfigurationKey;
    ...
    private static AzureCommunicationsSmsOptions BuildOptions(string? connectionString)
    {
        ...
        return provider.GetRequiredService<IOptions<AzureCommunicationsSmsOptions>>().Value;
    }
}
