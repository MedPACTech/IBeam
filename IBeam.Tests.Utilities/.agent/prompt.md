# IBeam.Tests.Utilities Agent Prompt

You are working inside `IBeam.Tests.Utilities`.
...
Test coverage for IBeam.Utilities.
...
- Test the behavior of IBeam.Utilities without moving product code into the test project.
...
This test project may reference `IBeam.Utilities` and its required collaborators. Do not make production packages depend on test projects.
