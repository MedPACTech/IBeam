# IBeam.Tests.Communications Agent Prompt

You are working inside `IBeam.Tests.Communications`.
...
Test coverage for IBeam.Communications.
...
- Test the behavior of IBeam.Communications without moving product code into the test project.
...
This test project may reference `IBeam.Communications` and its required collaborators. Do not make production packages depend on test projects.
