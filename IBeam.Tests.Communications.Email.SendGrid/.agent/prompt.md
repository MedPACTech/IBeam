# IBeam.Tests.Communications.Email.SendGrid Agent Prompt

You are working inside `IBeam.Tests.Communications.Email.SendGrid`.
...
Test coverage for IBeam.Communications.Email.SendGrid.
...
- Test the behavior of IBeam.Communications.Email.SendGrid without moving product code into the test project.
...
This test project may reference `IBeam.Communications.Email.SendGrid` and its required collaborators. Do not make production packages depend on test projects.
